...
export const produccionTrabajadores: ProduccionTrabajador[] = [
  ...
  { id: 'PD006', fecha: '2026-01-26', trabajadorId: 'T003', trabajadorNombre: 'Miguel Ángel Torres', accion: 'picar', origenId: 'BL002', origenNombre: 'A-002', tipo: 'Plancha', dimension: '160x60', cantidadLosas: 12, pagoPorLosa: 420, pagoTotal: 5040, bono: 0, pagoFinal: 5040, pagado: true },
]
...
export const mermas: Merma[] = [
  ...
  { id: 'M004', fecha: '2026-01-24', origenId: 'BL003', origenNombre: 'A-003', tipo: 'Plancha', dimension: '160x65', cantidadLosas: 2, metrosCuadrados: 2.08, motivo: 'Defecto de material', observaciones: 'Grieta natural descubierta al procesar' },
]
